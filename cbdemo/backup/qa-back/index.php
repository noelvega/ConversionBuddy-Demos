					...
					<fieldset>
						...
						<ul>
							...
							<li>
								<ul class="buttons">
									<li>
										<fb:like href="http://<?php echo $_SERVER['SERVER_NAME'] . "/" . $value->url; ?>" class="sb_like" send="false" layout="button_count" width="51px" style="width:51px;" show-faces="false" sb_params="{'pid':'<?php echo $value->id; ?>','plp':'http://<?php echo $_SERVER['SERVER_NAME'] . "/" . $value->url; ?>','pi':'http://<?php echo $_SERVER['SERVER_NAME'] . "/" . $value->imageUrl; ?>','pd':'<?php echo addSlashes($value->description);  ?>','pc':'<?php echo $value->category; ?>'}"></fb:like>
									</li>
								</ul>
							</li>
							<li>
