						...
						<div class="itemWrapper">
							...
							<div class="itemDescription">
								...
								<div class="socialContainer">
									<ul class="links">
										<li>
											<a class="sb_facebook">Share</a>
										</li>
										<li>
											<a class="sb_twitter">Tweet</a>
										</li>
										<li>
											<a class="sb_email">Email</a>
										</li>
										<li>
											<a class="sb_link">Link</a>
										</li>
										<li>
											<a class="sb_pinterest">Pinterest</a>
										</li>
									</ul>
									
									<ul class="share">
										<li>
											<fb:like href="http://<?php echo $_SERVER['SERVER_NAME'] . htmlspecialchars($_SERVER['REQUEST_URI']); ?>" class="sb_like"></fb:like>
										</li>
									</ul>
								</div>
