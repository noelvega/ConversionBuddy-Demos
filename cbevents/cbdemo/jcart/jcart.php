	...
	*/
	public function display_cart() {
		...
		if ($isCheckout !== true) {
			...
			echo tab(7) . "<button type='$inputType' $src id='jcart-checkout' name='jcartCheckout' class='jcart-button' value='{$config['text']['checkout']}'><div><span>{$config['text']['checkout']}</span></div></button>";
		}

		echo tab(7) . "<span class='subtotal' id='jcart-subtotal'>{$config['text']['subtotal']}: $currencySymbol" . "<strong id='get-the-subtotal'>" .number_format($this->subtotal, $priceFormat['decimals'], $priceFormat['dec_point'], $priceFormat['thousands_sep']) . "</strong></span>\n";
